# Multi-Plane Runtime Manager Architecture Diagram
...
flowchart TB
    ...
    subgraph Device[Device Side]
        ...
        subgraph DS[Multi-Plane Runtime Manager Process]
...
sequenceDiagram
    ...
    participant M as Multi-Plane Runtime Manager Main Thread
...
- Catalog file: JSON from default /etc/multi-plane-runtime-manager/catalog.json or startup override argument.
...
sequenceDiagram
    ...
    participant MAIN as Multi-Plane Runtime Manager Main Thread
    participant W as Worker Thread
